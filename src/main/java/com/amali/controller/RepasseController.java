...
public class RepasseController {
	...
	public ResponseEntity<List<Repasse>> findOrderByMunicipioEsferaModalidade(
			...
			Sort sort) {
		List<Repasse> result = repasseRepository.searchMunicipioEsferaModalidade(municipio, esferaGoverno, modalidadeEnsino,
				byMunicipio);
		return ResponseEntity.ok(result);
	}
	...
	public ResponseEntity<List<Repasse>> findOrderByMunicipioEsfera(
			...
			@RequestParam(defaultValue = "") String esferaGoverno,
			Sort sort) {
		List<Repasse> result = repasseRepository.searchMunicipioEsfera(municipio, esferaGoverno,
				byMunicipio);
		return ResponseEntity.ok(result);
	}
	...
	public ResponseEntity<List<Repasse>> findOrderByNomeMunicipio(
			@RequestParam(defaultValue = "") String municipio,
			Sort sort) {
		List<Repasse> result = repasseRepository.searchMunicipio(municipio, byMunicipio);
		return ResponseEntity.ok(result);
	}
	...
	public ResponseEntity<List<Repasse>> findOrderByModalidade(
			@RequestParam(defaultValue = "") String modalidadeEnsino,
			Sort sort) {
		List<Repasse> result = repasseRepository.searchModal(modalidadeEnsino,
				(Sort.by(Sort.Direction.ASC, "modalidadeEnsino")));
		return ResponseEntity.ok(result);
	}
	...
	public ResponseEntity<List<Repasse>> findOrderByEsfera(
			@RequestParam(defaultValue = "") String esferaGoverno,
			Sort sort) {
		List<Repasse> result = repasseRepository.searchEsfera(esferaGoverno,
				(Sort.by(Sort.Direction.ASC, "esferaGoverno")));
		return ResponseEntity.ok(result);
	}
