...
public class DemandaEscolas implements Serializable{
	...
	public DemandaEscolas() {
	}

	public DemandaEscolas(Long id, int janeiro, int fevereiro, int marco, int abril, int maio, int junho, int julho,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DemandaEscolas other = (DemandaEscolas) obj;
